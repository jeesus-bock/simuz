...
var ItemDefs = []*items.ItemDef{
	...
	defineSubstance("bread", "Bread", 2, 0.4,
		&items.SubstanceEffect{Name: "Sustenance", HealHP: 6}),
	...
	defineSubstance("iron_rations", "Iron Rations", 5, 1.0,
		&items.SubstanceEffect{Name: "Sustenance", HealHP: 15}),
	defineSubstance("smoked_meat", "Smoked Meat", 4, 0.8,
		&items.SubstanceEffect{Name: "Sustenance", HealHP: 12}),
	defineSubstance("lembas_bread", "Lembas Bread", 20, 0.3,
		&items.SubstanceEffect{Name: "Sustenance", HealHP: 25, HealFP: 10}),
	defineSubstance("dwarven_ale", "Dwarven Ale", 8, 1.0,
		&items.SubstanceEffect{Name: "Drunk (Dwarven Ale)", Duration: 25, CrashDuration: 13,
			STR: 3, CON: 3, INT: -2, WIS: -2, CHA: -1,
			CrashSTR: -2, CrashCON: -1}),
	defineSubstance("pipeweed", "Pipeweed", 12, 0.2,
		&items.SubstanceEffect{Name: "Mellow", Duration: 20, CrashDuration: 10,
			WIS: 2, CHA: 1, DEX: -1,
			CrashWIS: -1, CrashCHA: -1}),
	defineSubstance("crude_bandage", "Crude Bandage", 3, 0.2,
		&items.SubstanceEffect{Name: "Regeneration", Duration: 8, HealPerTick: 1}),
	defineItem("torch", "Torch", items.TypeMisc, 1.0, 2, ""),
	defineItem("kitchen_knife", "Kitchen Knife", items.TypeWeapon, 0.4, 8, "weapon"),
	defineItem("pocket_knife", "Pocket Knife", items.TypeWeapon, 0.2, 5, "weapon"),
	defineItem("charged_quartz", "Charged Quartz", items.TypeMisc, 0.3, 50, ""),
	defineItem("whetstone", "Whetstone", items.TypeMisc, 0.5, 3, ""),
	defineItem("pouch_of_pebbles", "Pouch of Pebbles", items.TypeMisc, 1.0, 2, ""),
	defineItem("pocket_watch", "Pocket Watch", items.TypeMisc, 0.1, 15, ""),
	defineItem("glow_stone", "Glow Stone", items.TypeMisc, 0.3, 20, ""),
	defineItem("quiver_of_arrows", "Quiver of Arrows", items.TypeMisc, 1.5, 12, ""),
	defineItem("heavy_iron_plate", "Heavy Iron Plate", items.TypeArmor, 25, 300, "body"),
	defineItem("double_bit_axe", "Double-Bit Axe", items.TypeWeapon, 5, 120, "weapon"),
	defineItem("spiked_leather_harness", "Spiked Leather Harness", items.TypeArmor, 8, 60, "body"),
	defineItem("barbed_javelin", "Barbed Javelin", items.TypeWeapon, 3, 45, "weapon"),
	defineItem("elven_chainmail", "Elven Chainmail", items.TypeArmor, 10, 250, "body"),
	defineItem("recurve_longbow", "Recurve Longbow", items.TypeWeapon, 2, 150, "weapon"),
	defineItem("silver_shortsword", "Silver Shortsword", items.TypeWeapon, 1.5, 80, "weapon"),
	defineItem("padded_tunic", "Padded Tunic", items.TypeArmor, 2, 12, "body"),
	defineItem("hunting_slingshot", "Hunting Slingshot", items.TypeWeapon, 0.5, 10, "weapon"),
	defineItem("sturdy_dagger", "Sturdy Dagger", items.TypeWeapon, 0.5, 15, "weapon"),
}
